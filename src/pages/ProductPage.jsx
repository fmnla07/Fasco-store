      ...
      <nav className="navbar navbar-expand-lg bg-white py-3">
        ...
        <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
          <ul className="navbar-nav text-center">
            ...
            <li className="nav-item mx-2">
              <a className="nav-link small text-secondary" href="/ShopPage">
                Shop
              </a>
            </li>
            <li className="nav-item mx-2">
              <a className="nav-link active small text-dark border-bottom border-2 border-dark" href="/ProductPage">
                Products
              </a>
            </li>
    ...
    <div className="container my-5 product-detail">
      ...
      <div className={`cart-sidebar ${cartOpen ? "open" : ""}`}>
        ...
        <div className="cart-body p-3">
          ...
          {/* Buttons */}
          <Link to="/Checkout" className="btn btn-dark w-100 mb-2">Checkout</Link>
          <Link to="/Cart" className="btn border-bottom w-100">View Cart</Link>
        </div>
      </div>
