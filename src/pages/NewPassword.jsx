        ...
        <div className="d-flex align-items-center justify-content-center min-vh-100 p-3">
            ...
            >
                ...
                <div className="col-12 col-md-6 p-0">
                    <img src="images/Rectangle1.png" alt="sign in" className="img-fluid w-100 h-100" style={{ objectFit: "cover" }} />
                </div>


                {/* RIGHT FORM SECTION */}
                <div className="login-form p-5">
                    <a className="mb-5" href="/"><img src="/images/FASCO.png" alt="man" /></a>
                    ...
                    <form>
                        ...
                        <button className="btn btn-primary w-100 rounded-3 py-2 fw-semibold"><Link to="/" className="text-decoration-none text-light">Submit</Link></button>
                    </form>
