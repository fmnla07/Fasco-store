    ...
    <div className="d-flex align-items-center justify-content-center min-vh-100 p-3">
      ...
      >
        ...
        <div className="col-12 col-md-6 p-0">
          <img src="images/Rectangle2.png" alt="sign in" className="img-fluid w-100 h-100" style={{ objectFit: "cover" }} />
        </div>
        ...
        <div className="signUp-form p-5">
          ...
          <form>
            ...
            <button className="btn btn-dark w-100 rounded-3 py-2 fw-semibold mt-4">
              <Link to="/Signin" className="text-decoration-none text-light">Create Account</Link>
            </button>
